				...
				<div class="panel-body">
					<div class="row">
						<div class="col-md-4">
							...
							<div>
								<xsl:choose>
									<xsl:when test="BusinessSectorJob/hasDriversLicense = 'true'">Tjänsten kräver att sökande har körkort av typ <xsl:value-of select="DriversLicenseType/name"></xsl:value-of>.</xsl:when>
