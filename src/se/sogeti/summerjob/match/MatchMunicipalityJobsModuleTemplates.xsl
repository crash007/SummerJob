...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:template match="Area1AndGeoArea1Candidates">
		<xsl:call-template name="candidatesTableTemplate">
			<xsl:with-param name="header"
				select="'Matchande förstahandsval på verksamhetsområde och geografiskt område'" />
		</xsl:call-template>
	</xsl:template>
	...
	<xsl:template match="Area1AndGeoArea2Candidates">
		<xsl:call-template name="candidatesTableTemplate">
			<xsl:with-param name="header"
				select="'Matchande förstahandsval på verksamhetsområde och andrahandsval på geografiskt område'" />
		</xsl:call-template>
	</xsl:template>
	...
	<xsl:template match="Area1AndGeoArea3Candidates">
		<xsl:call-template name="candidatesTableTemplate">
			<xsl:with-param name="header"
				select="'Matchande förstahandsval på verksamhetsområde och tredjehandsval på geografiskt område'" />
		</xsl:call-template>
	</xsl:template>
	...
	<xsl:template match="AnyAreaAndGeoArea1Candidates">
		<xsl:call-template name="candidatesTableTemplate">
			<xsl:with-param name="header"
				select="'Godtyckligt verksamhetsområde och förstahandsval på geografiskt område'" />
		</xsl:call-template>
	</xsl:template>
	...
	<xsl:template match="AnyAreaAndGeoArea2Candidates">
		<xsl:call-template name="candidatesTableTemplate">
			<xsl:with-param name="header"
				select="'Godtyckligt verksamhetsområde och andrahandsval på geografiskt område'" />
		</xsl:call-template>
	</xsl:template>
	...
	<xsl:template match="AnyAreaAndGeoArea3Candidates">
		<xsl:call-template name="candidatesTableTemplate">
			<xsl:with-param name="header"
				select="'Godtyckligt verksamhetsområde och tredjehandsval på geografiskt område'" />
		</xsl:call-template>
	</xsl:template>
	...
	<xsl:template match="Area2AndGeoArea1Candidates">
		<xsl:call-template name="candidatesTableTemplate">
			<xsl:with-param name="header"
				select="'Andrahandsval på verksamhetsområde och förstahandsval på geografiskt område'" />
		</xsl:call-template>
	</xsl:template>
	...
	<xsl:template match="Area3AndGeoArea1Candidates">
		<xsl:call-template name="candidatesTableTemplate">
			<xsl:with-param name="header"
				select="'Tredjehandsval på verksamhetsområde och förstahandsval på geografiskt område'" />
		</xsl:call-template>
	</xsl:template>
	...
	<xsl:template match="Area3AndGeoArea2Candidates">
		<xsl:call-template name="candidatesTableTemplate">
			<xsl:with-param name="header"
				select="'Tredjehandsval på verksamhetsområde och andrahandsval på geografiskt område'" />
		</xsl:call-template>
	</xsl:template>
	...
	<xsl:template match="MunicipalityJobApplication">
		<div class="mgn-btm8px candidate">
			...
			<div class="row">
				<div class="col-xs-5 col-md-2 bold">Körkort</div>
				<div class="col-md-4">
			...
			<div class="row">
				<div class="col-xs-5 col-md-2 bold">Önskad arbetsperiod</div>
			...
			<div class="row collapse">
				<div class="col-xs-5 col-md-2 bold">Område 1</div>
			...
			<div class="row collapse">
				<div class="col-xs-5 col-md-2 bold">Område 2</div>
				<div class="col-md-4 social-number">
			...
			<div class="row collapse">
				<div class="col-xs-5 col-md-2 bold">Område 3</div>
				<div class="col-md-4 social-number">
...
<!-- 					</div> -->
					...
					<div class="row mgn-top8px collapse">
						...
						<div class="col-xs-5 col-md-3 bold">Verksamhetsområde</div>
						<div class="col-md-3">
					...
					<div class="row mgn-top8px collapse">
						<div class="col-xs-5 col-md-3 bold">Övriga krav och önskemål</div>
						<div class="col-md-9 col-xs-12">
					...
					<div class="row  mgn-top8px collapse">
						...
						<div class="col-xs-5 col-md-3 bold">Körkort</div>
						<div class="col-md-3">
							<xsl:value-of select="DriversLicenseType/name" />
						</div>
						<div class="col-xs-5 col-md-3 bold">Över 18</div>
						<div class="col-md-3">
							<xsl:choose>
					...
					<div class="row collapse">
						...
						<div class="col-xs-5 col-md-3 bold">Förvaltning</div>
						<div class="col-md-3">
					...
					<div class="collapse">
						...
						<div class="row mgn-top8px">
							<div class="col-xs-5 col-md-3 bold">Förnamn</div>
							<div class="col-md-3">
