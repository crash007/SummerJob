				...
				<div class="row">
					...
					<div class="col-md-12">	
						...
						<div class="row">
							...
							<div class="col-md-3"><xsl:value-of select="company"/></div>
							<div class="col-xs-4 col-md-3 bold">Organisationsnummer</div>
							<div class="col-md-3"><xsl:value-of select="corporateNumber"/></div>
							...
							<div class="col-md-5">
								<xsl:choose>
									<xsl:when test="inChargeOfInterviews = 'true'">
										<span class="prio">Arbetsgivaren vill att kommunen tar hand om intervjuer</span>
									</xsl:when>	
									<xsl:otherwise>
